...
export default function PortfolioSection() {
    ...
    return (
        <section ref={sectionRef} className="relative md:py-10 sm:py-5 py-0 overflow-hidden">
            {/* Header */}
            <motion.div
                className="container"
            ...
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                    ...
                    <div className="space-y-6">
                        ...
                        >
                            <div className="relative overflow-hidden aspect-[16/11] rounded-lg">
                                <motion.div
                        ...
                        <motion.div
                            ...
                            onMouseLeave={() => setHoveredCard(null)}
                        >
                            <div className="relative overflow-hidden aspect-[16/13] rounded-lg">
                                <motion.div
                                    className="absolute inset-0"
                                    variants={imageVariants}
                                >
